...
namespace Nowo\PasswordStrengthBundle\DependencyInjection\Compiler;
...
{
    private const TWIG_NAMESPACE = 'NowoPasswordStrengthBundle';
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        if ($container->hasParameter('kernel.project_dir')) {
            ...
            if (is_string($projectDirParam)) {
                ...
                $overridePath = $projectDir . '/templates/bundles/NowoPasswordStrengthBundle';
