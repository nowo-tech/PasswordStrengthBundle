...
{
    public const TOGGLE_PASSWORD_TYPE = 'Nowo\PasswordToggleBundle\Form\Type\PasswordType';
    ...
    /**
     * @param class-string<\Symfony\Component\Form\AbstractType> $parentFormType
     */
