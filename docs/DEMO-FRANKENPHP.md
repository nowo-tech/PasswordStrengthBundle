...
- **Password toggle:** demo installs `nowo-tech/password-toggle-bundle` via Composer (Packagist); only `password-strength-bundle` uses a path repo for local development.
